...
import com.phasmidsoftware.dsaipg.huskySort.sort.SortException;
import com.phasmidsoftware.dsaipg.huskySort.sort.SortWithHelper;
import com.phasmidsoftware.dsaipg.huskySort.sort.Sorter;
import com.phasmidsoftware.dsaipg.huskySort.sort.huskySortUtils.*;
import com.phasmidsoftware.dsaipg.huskySort.sort.radix.Alphabet;
import com.phasmidsoftware.dsaipg.huskySort.sort.radix.CharacterMap;
import com.phasmidsoftware.dsaipg.huskySort.sort.radix.MSDStringSort;
import com.phasmidsoftware.dsaipg.huskySort.sort.radix.UnicodeMSDStringSort;
import com.phasmidsoftware.dsaipg.huskySort.sort.simple.TimSort;
import com.phasmidsoftware.dsaipg.huskySort.sort.simple.*;
...
public final class HuskySortBenchmark {
    ...
    private static int getRepetitions(final int n, final int totalOps) {
        return MIN_REPS + (int) round(totalOps / minComparisons(n));
    }
    ...
    static <T extends Comparable<T>> Supplier<T[]> getSupplier(final int n, final Class<T> clazz, final Function<Random, T> randomNumberFunction) {
        return () -> fillRandomArray(clazz, new Random(), n, randomNumberFunction);
    }
    ...
    static class Tuple implements HuskySortable<Tuple> {
        ...
        private static String[] getCommonWords() {
            return HuskySortBenchmarkHelper.getWords(COMMON_WORDS_CORPUS, HuskySortBenchmark::lineAsList);
        }
