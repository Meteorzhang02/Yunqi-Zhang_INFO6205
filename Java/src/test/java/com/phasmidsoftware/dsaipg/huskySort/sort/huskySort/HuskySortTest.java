...
import com.phasmidsoftware.dsaipg.huskySort.sort.InstrumentedComparisonSortHelper;
...
import com.phasmidsoftware.dsaipg.huskySort.sort.huskySortUtils.HuskyHelper;
import com.phasmidsoftware.dsaipg.huskySort.sort.huskySortUtils.HuskySortable;
...
import static com.phasmidsoftware.dsaipg.huskySort.sort.huskySortUtils.HuskySortHelper.generateRandomAlphaBetaArray;
...
public class HuskySortTest {
    ...
    public void testSortOldDate() {
        ...
        final AbstractHuskySort<Date> sorter = new QuickHuskySort<>(HuskyCoderFactory.dateCoder, config);
        assertTrue("sorted", sorter.getHelper().sorted(sorter.sort(xs)));
    }
    ...
    public void testSortJavaTime() {
        ...
        final QuickHuskySort<ChronoLocalDateTime<?>> sorter = new QuickHuskySort<>(HuskyCoderFactory.chronoLocalDateTimeCoder, config);
        assertTrue("sorted", sorter.getHelper().sorted(sorter.sort(xs)));
    }
